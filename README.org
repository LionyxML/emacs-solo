...
- =curl=
  ...
  Also used for =emacs-solo-weather= and =emacs-solo-rate=.
...
- =mpv=
  ...
  or listen to online radio with =C-c r=.
...
- =gemmini-cli=
  ...
  Only needed if you'd like to use =emacs-solo/gemini-run-model=.


- =khard=

  Only needed if you'd like to use =emacs-solo/khard-...= funcitons.
